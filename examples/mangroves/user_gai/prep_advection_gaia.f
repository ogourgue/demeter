...
!
      INTEGER :: I
      DOUBLE PRECISION :: AUX,VITCD,FD90
!
!======================================================================!
!                               PROGRAM                                !
!======================================================================!
...
!         TIDE BOUNDARY
          IF(X(I) <= -1000.D0) THEN
            AUX = 0.D0
          ELSEIF(X(I) <= 0.D0) THEN
            AUX = AUX * (X(I) + 1000.D0) / 1000.D0
          ENDIF
!
! END TIGER
! ----------------------------------------------------------------------
...
!       UNIFORM SEDIMENT ALONG THE VERTICAL
        CALL CPSTVC(TOBCW_MEAN,CSRATIO)
        CALL OS('X=C     ', X=CSRATIO, C=1.D0)
!
!       **********************************************************
...
!       DMK Modification 06/05/2011
     ...
     &                        KARMAN,ZERO,XWC(J),ZREF,CSRATIO)
...
!       ****************************************************
!
        CALL OS('X=CY    ', X=FLUDPT%ADR(J)%P, Y=CSRATIO, C=XWC(J))
!
      ENDIF
!
