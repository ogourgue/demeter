...
!
!     FLUX OF MASS AT BOUNDARY FOR TRACER
!
...
!
      INTEGER, PARAMETER :: MAXLU_T2D = 53
!
...
!     AUTOMATIC EX ARRAYS!!!!!!
     ...
     &                   'Z0  '/)
      ...
      LOGICAL :: PROSOU_FV_DEJALU = .FALSE.
!
      ! telemac2d.F
...
!
!     HYDROPERIOD
      TYPE(BIEF_OBJ), TARGET :: TH
!
!     EXCEEDING BOTTOM SHEAR IMPULSE
      TYPE(BIEF_OBJ), TARGET :: JB
!
!     COVERAGE
      TYPE(BIEF_OBJ), TARGET :: COV
!
!     AGE
      TYPE(BIEF_OBJ), TARGET :: AGE
!
! END TIGER
! ----------------------------------------------------------------------
!
